/*
  ...
  - The values [SELECTPAGE] on the enum `ConfigPageType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ConfigPageType_new" AS ENUM ('INSTRUCTIONS', 'HOWITWORKS', 'PRESENTATION', 'ITEM', 'SPECKRESULT', 'INTERVIEW', 'SELECTQUESTIONNAIRE', 'SELECTNAME');
